...
use shaders::{load_preprocess_shaders, PREPROCESS_SHADER};

#[derive(Component)]
struct ComputeDistortionFromLesion(Task<CommandQueue>);
...
pub struct PreprocessLensPlugin;

impl Plugin for PreprocessLensPlugin {
...
impl FromWorld for ComputePipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let shader = world.load_asset(PREPROCESS_SHADER);
